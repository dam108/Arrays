...
public class EjArrays0701d {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < temperaturaMeses.length; i++) {
            ...
            // en cada iteracion comparamos cual es la temperatura maxima y la guardamos 
             tempMaxi = Math.max(maxima, temperaturaMeses[i]);
             maxima = tempMaxi;

        }
       
        // imprimimos la temperatura maxima
        if (maxima < 0){
            System.out.printf("La temperatura maxima del año es: %d", maxima);
        } else System.out.printf("La temperatura maxima del año es: +%d", maxima);
